...
#Ejercicio 8: Escribí una función recursiva llamada contar_digito(numero, digito) que reciba un número entero positivo (numero) y un dígito 
...
print(f"El digito {digito} se repite {contar_digito(numero, digito)} veces en {numero}")