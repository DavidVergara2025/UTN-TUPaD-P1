...
#Ejercicio 10.Crear una función llamada calcular_promedio(a, b, c) que reciba tres números como parámetros 
...
#PROGRAMA PRINCIPAL
a= float(input("Ingrese el primer número a promediar: "))
